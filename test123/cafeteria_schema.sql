...
CREATE TABLE orders (
                        ...
                        status smallint NOT NULL DEFAULT 'PENDING', -- PENDING, CONFIRMED, PREPARING, READY, COMPLETED, CANCELLED
...
CREATE TABLE payment (
                         ...
                         payment_method smallint NOT NULL, -- CARD, CASH, MOBILE, STUDENT_CARD
                         payment_status smallint NOT NULL DEFAULT 'PENDING', -- PENDING, COMPLETED, FAILED, REFUNDED
...
CREATE TABLE report (
                        ...
                        reason_code smallint(20) NOT NULL,
                        status smallint NOT NULL DEFAULT 'PENDING', -- PENDING, REVIEWED, RESOLVED, REJECTED
                        created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
